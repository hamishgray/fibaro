                    ...
                    <p class="site-slider-slider-one-text-description">
						<?php 
                            if( of_get_option('slider_one_text') ){
                               ...
                               _e('Welcome to FIBARO e-learning Knowledge Platform!',  'alexandria');
                            }
                        ?>                     
                    </p>
                    <p class="site-slider-slider-one-text-button">
                        <a href="<?php if( of_get_option('slider_one_cta_link') ){ echo esc_url( of_get_option('slider_one_cta_link') );}else { echo 'list';}?>">
							<?php 
                                if( of_get_option('slider_one_cta') ){
                                    echo esc_attr( of_get_option('slider_one_cta') );
                                }else {
									_e('Browse courses',  'alexandria');
                                }
                            ?>
                        </a>                    
                    </p>
