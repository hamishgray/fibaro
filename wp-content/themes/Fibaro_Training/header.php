...
<head>
  ...
  <?php
    wp_enqueue_style(
      'style_v2',
      get_template_directory_uri() . '/style-v2.css',
      null,
      null
    );
  ?>
    ...
    <div class="site-header__container">
      ...
      <?php if( !of_get_option('logo_layout_style') || of_get_option('logo_layout_style') == 'sbys' ) : ?>
        ...
        <div class="site-branding">
        	...
        	<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="https://training.fibaro.com.au/wp-content/uploads/2018/12/fibaro-logo-new.png" /></a>
      ...
      <div class="site-header-half-width-nav">
        <nav id="site-navigation" class="main-navigation" role="navigation">
          <div class="screen-reader-text skip-link">
            <a href="#content" title="<?php esc_attr_e( 'Skip to content', 'alexandria' ); ?>"><?php _e( 'Skip to content', 'alexandria' ); ?></a>
          </div>
